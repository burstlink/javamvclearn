...
import com.learnmvc.controller.IndexController;
import com.learnmvc.controller.UserController;
...
public class DispatcherServlet extends HttpServlet {
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp, Map<String,
            ? extends AbstractDispatcher> dispatcherMap) throws IOException, ServletException {
...
abstract class AbstractDispatcher {
    public abstract ModelAndView invoke(HttpServletRequest request, HttpServletResponse response) throws
